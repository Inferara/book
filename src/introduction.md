...
Additional resources and references are provided in the [appendix](./appendix/appendix.md) section for further reading and exploration. The [infs CLI Reference](./appendix/d-infs-reference.md) appendix provides a complete guide to the toolchain manager.
